...
export default function Ventajas ({subtitulo, ventajas} : VentajasProps) {
  return (
        ...
        <div className="grid grid-cols-4 w-3/4 gap-0 mx-auto">

          {
            ventajas.map((ventaja) => (
              <div className="bg-white shadow-md rounded-lg overflow-hidden scale-[0.90]" key={ventaja.id}>
