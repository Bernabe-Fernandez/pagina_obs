...
export default function Empresas() {
  return (
    <div className="flex flex-col justify-center items-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 my-16 md:my-24 lg:my-28 text-center">
      ...
      {/* TÍTULO */}
      <h3 className='uppercase text-2xl sm:text-3xl md:text-4xl font-bold text-blue-900 mb-4 md:mb-6'>
        Ellos ya confían en nosotros
      </h3>

      {/* DESCRIPCIÓN */}
      <p className="text-base sm:text-lg md:text-xl text-blue-900 mb-8 md:mb-10 max-w-3xl">
