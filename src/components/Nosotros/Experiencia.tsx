...
export default function Experiencia() {
  return (
        <>
            <div>
                <p className="text-[#2E6092] text-center max-w-5xl mx-auto leading-relaxed text-lg">
                ...
                <section className= "w-full bg-white py-28">
                    <div className="max-w-6xl mx-48 px-6 lg:px-12 grid lg:grid-cols-2 gap-12 items-center">
                        {/* Imagen */}
                        <div className="flex items-center justify-start h-screen w-full">
                            <img 
                                src="/images/nosotros/experiencia.jpg"  
                                alt="nuestra experiencia" 
                                className="w-full max-w-sm rounded-5xl shadow-lg"
                            />
                        </div>
