...
return (
  <nav className="sticky top-0 left-0 w-full z-20 bg-white">
    <div className="max-w-7xl mx-auto px-6 lg:px-2 py-2 flex justify-between items-center">
      <Link to="/">
        <img
          src="/images/logos/internos/logotipo.png"
          alt="logo omnibandas"
      ...
      <ul
        className={`uppercase font-medium text-azulobs-500 gap-6
          lg:flex lg:justify-center lg:static lg:h-auto
          ${viewMenu ? "flex flex-col absolute top-full left-0 w-full bg-white p-6 shadow-md" : "hidden"}`}
      >
        {/* NORMAL LINKS */}
        <li className="hover:bg-azulobs-600 hover:text-white">
          <NavLink
            ...
            className={({ isActive }) =>
              `block w-full p-2 ${
                isActive
                  ? "text-azulobs-700 hover:text-white font-bold border-b-2 border-azulobs-600"
                  : ""
              }`
            }
          >
        ...
        {/* PRODUCTOS DROPDOWN (ESCRITORIO) */}
        <li className="relative group p-2 hover:bg-azulobs-600 hover:text-white">
          <span className="cursor-pointer">Productos</span>

          <div className="absolute hidden group-hover:block top-full left-0 bg-white shadow-xl border rounded-lg p-6 w-80 md:w-[600px] z-50">
            <ul className="grid grid-cols-1 md:grid-cols-3 gap-2 text-[15px] text-azulobs-600">
              <li className="hover:bg-azulobs-600 hover:text-white p-1">
                <NavLink
                  to="/productos/bandas"
                  className={({ isActive }) =>
              ...
              <li className="hover:bg-azulobs-600 hover:text-white p-1">
                <NavLink
                  to="/productos/transmision"
                  className={({ isActive }) =>
                    `${isActive ? "text-azulobs-700 hover:text-white font-bold border-b-2 border-azulobs-600" : ""}`
                  }
                >
                  Bandas de transmision de potencia
                </NavLink>
              </li>
              <li className="hover:bg-azulobs-600 hover:text-white p-1">
                <NavLink
                  to="/productos/modulares"
                  className={({ isActive }) =>
                    `${isActive ? "text-azulobs-700 hover:text-white font-bold border-b-2 border-azulobs-600" : ""}`
                  }
                >
        ...
        {/* INDUSTRIAS DROPDOWN (ESCRITORIO) */}
        <li className="relative group p-2 hover:bg-azulobs-600 hover:text-white">
          <span className="cursor-pointer">Industrias</span>
        ...
        {/* RESTO DE LINKS (CELULAR TAMBIÉN CIERRA MENÚ) */}
        <li className="hover:bg-azulobs-600 hover:text-white">
          <NavLink
            to="/catalogo"
            onClick={() => setViewMenu(false)}
      ...
      <div className="flex gap-4 justify-center">
        <button
          className="lg:hidden text-azulobs-700 hover:text-azulobs-500"
          onClick={() => setViewMenu(!viewMenu)}
        >
          {viewMenu ? <FaRegWindowClose size={24} /> : <GiHamburgerMenu size={24} />}
        </button>
