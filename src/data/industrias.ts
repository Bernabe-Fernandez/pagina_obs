...
export const industriasPage : industriaTipo[] = [
    ...
    subtituloCondicion: "En la industria de verduras y legumbres, las condiciones de operación requieren sistemas de transporte capaces de mantener un flujo constante y un manejo controlado del producto, incluso en entornos de alta exigencia.",
    condiciones: [
      {
        id: 1,
    ...
    subtituloCondicion: "En la industria tequilera, las condiciones de operación requieren sistemas de transporte capaces de adaptarse a procesos continuos, manejar altos volúmenes de producto y operar de forma confiable en entornos exigentes, manteniendo la estabilidad y el control a lo largo del proceso.",
    condiciones: [
      {
        id: 1,
        icono: "/images/Industria/tequilera/condicion/icono1.svg",
        titulo: "Procesos continuos",
        descripcion: "Sistemas diseñados para operar de forma continua, acompañando las distintas etapas del proceso.",
      },
      {
        id: 2,
        icono: "/images/Industria/tequilera/condicion/icono2.svg",
        titulo: "Altos volúmenes de producto",
        descripcion: "Soluciones capaces de manejar grandes volúmenes de producto, manteniendo un flujo constante y eficiente.",
      },

      {
        id: 3,
        icono: "/images/Industria/tequilera/condicion/icono3.svg",
        titulo: "Entornos exigentes de operación",
        descripcion: "Equipos preparados para trabajar en condiciones industriales demandantes, garantizando rendimiento y durabilidad.",
      },

      {
        id: 4,
        icono: "/images/Industria/tequilera/condicion/icono4.svg",
        titulo: "Control y estabilidad del proceso",
        descripcion: "Sistemas que permiten un manejo controlado del producto, contribuyendo a la estabilidad y calidad del proceso.",
      },
    ],
    ...
    id: 11,
    tipo: "farmaceutica",
    descripcion : "La industria farmacéutica exige procesos altamente controlados, donde la precisión y la continuidad operativa son fundamentales. El transporte interno debe facilitar el manejo ordenado del producto, asegurar transferencias controladas entre etapas y adaptarse a entornos regulados y de alta exigencia técnica.",
    titulo: "Industria chocolatera", 
    ...
    subtituloCondicion: "En la industria farmacéutica, las condiciones de operación requieren sistemas de transporte altamente controlados, capaces de operar de forma continua y precisa, asegurando la estabilidad del proceso y la repetibilidad en cada etapa de producción.",
    condiciones: [
      {
        id: 1,
        icono: "/images/Industria/farmaceutica/condicion/icono1.svg",
        titulo: "Alta precisión en el manejo",
        descripcion: "Sistemas diseñados para garantizar un manejo preciso del producto, reduciendo variaciones y errores.",
      },
      {
        id: 2,
        icono: "/images/Industria/farmaceutica/condicion/icono2.svg",
        titulo: "Procesos continuos controlados",
        descripcion: "Soluciones capaces de operar de forma continua, manteniendo condiciones estables y controladas.",
      },

      {
        id: 3,
        icono: "/images/Industria/farmaceutica/condicion/icono3.svg",
        titulo: " Control del proceso",
        descripcion: "Equipos que permiten monitorear y controlar el flujo y el manejo del producto, contribuyendo a la eficiencia y calidad.",
      },

      {
        id: 4,
        icono: "/images/Industria/farmaceutica/condicion/icono4.svg",
        titulo: " Sistemas automatizados",
        descripcion: "Sistemas compatibles con procesos automatizados, favoreciendo la repetibilidad y el control operativo.",
      },
    ],
    ...
    id: 12,
    tipo: "cartonera",
    descripcion : "La industria cartonera abarca procesos de fabricación, armado y manejo de productos de cartón. El transporte interno debe facilitar el desplazamiento continuo de láminas, cajas y empaques, integrándose de forma eficiente con equipos de producción y líneas de empaque.",
    titulo: "Industria chocolatera", 
    url: "/images/catalagos/industria/cartonera/cartonera.pdf",
    ...
    subtituloCondicion: "La industria cartonera opera con altos volúmenes de material y procesos continuos que requieren sistemas de transporte robustos, estables y capaces de mantener un flujo constante del producto a lo largo de toda la línea.",
    condiciones: [
      {
        id: 1,
        icono: "/images/Industria/cartonera/condicion/icono1.svg",
        titulo: "Altos volúmenes de producción",
        descripcion: "Procesos diseñados para manejar grandes cantidades.",
      },
      {
        id: 2,
        icono: "/images/Industria/cartonera/condicion/icono2.svg",
        titulo: "Procesos continuos",
        descripcion: "Operación ininterrumpida que exige sistemas confiables.",
      },

      {
        id: 3,
        icono: "/images/Industria/cartonera/condicion/icono3.svg",
        titulo: " Manejo estable del material",
        descripcion: "Transporte que garantiza estabilidad del cartón durante el proceso.",
      },

      {
        id: 4,
        icono: "/images/Industria/cartonera/condicion/icono4.svg",
        titulo: "Integración con maquinaria existente",
        descripcion: "Sistemas compatibles con equipos de corte, formado, plegado y empaquetado ya instalados en la línea.",
      },
    ],
    ...
    titulo: "Industria chocolatera", 
    url: "/images/catalagos/industria/piedrera/piedrera.pdf",
    ...
    id: 14,
    tipo: "embutidos",
    descripcion : "La industria de embutidos requiere un manejo cuidadoso del producto durante sus distintas etapas de procesamiento y empaque. El transporte interno debe mantener un flujo continuo y estable, permitiendo la continuidad operativa sin comprometer la integridad ni las condiciones del producto.",
    titulo: "Industria chocolatera", 
    url: "/images/catalagos/industria/embutidos/embutidos.pdf",
    ...
    subtituloCondicion: "En la industria de embutidos, las condiciones de operación requieren sistemas de transporte capaces de mantener procesos continuos, higiénicos y estables, asegurando un manejo eficiente del producto durante cada etapa del proceso.",
    condiciones: [
      {
        id: 1,
        icono: "/images/Industria/embutidos/condicion/icono1.svg",
        titulo: "Procesos continuos",
        descripcion: "Procesos diseñados para mantener un movimiento constante del producto durante las distintas etapas de operación.",
      },
      {
        id: 2,
        icono: "/images/Industria/embutidos/condicion/icono2.svg",
        titulo: "Manejo y cuidado",
        descripcion: "Sistemas orientados al transporte estable del producto, ayudando a conservar su integridad durante el proceso.",
      },

      {
        id: 3,
        icono: "/images/Industria/embutidos/condicion/icono3.svg",
        titulo: "Integración con maquinaria",
        descripcion: "Soluciones compatibles con equipos de procesamiento, empaque y automatización industrial.",
      },

      {
        id: 4,
        icono: "/images/Industria/embutidos/condicion/icono4.svg",
        titulo: "Automatización y repetitividad",
        descripcion: "Sistemas preparados para líneas de operación automatizadas y procesos de producción repetitivos.",
      },
    ],
    ...
    id: 15,
    tipo: "frutas",
    descripcion : "La industria de frutas requiere sistemas de transporte capaces de mantener un flujo continuo del producto sin comprometer su calidad e integridad. En estos procesos, es fundamental contar con soluciones que permitan un manejo estable y eficiente, incluso en entornos donde la humedad y los residuos orgánicos están presentes de forma constante.",
    titulo: "Industria chocolatera", 
    ...
    subtituloCondicion: "En la industria de frutas, las condiciones de operación requieren sistemas de transporte capaces de adaptarse a procesos continuos, manejo cuidadoso del producto y entornos con presencia constante de humedad.",
    condiciones: [
      {
        id: 1,
        icono: "/images/Industria/frutas/condicion/icono1.svg",
        titulo: "Manejo y cuidado del producto",
        descripcion: "Sistemas orientados al transporte estable del producto, ayudando a conservar su integridad durante el proceso.",
      },
      {
        id: 2,
        icono: "/images/Industria/frutas/condicion/icono2.svg",
        titulo: "Producción continua y flujo",
        descripcion: "Soluciones diseñadas para mantener un movimiento constante del producto durante las distintas etapas de operación.",
      },

      {
        id: 3,
        icono: "/images/Industria/frutas/condicion/icono3.svg",
        titulo: "Volumen variable",
        descripcion: "Sistemas adaptables a distintos volúmenes y ritmos de producción según la temporada o demanda operativa.",
      },

      {
        id: 4,
        icono: "/images/Industria/frutas/condicion/icono4.svg",
        titulo: "Precisión en el manejo",
        descripcion: "Equipos compatibles con líneas de selección, empaque y automatización industrial.",
      },
    ],
    ...
    id: 16,
    tipo: "textil",
    descripcion : "La industria textil requiere sistemas de transporte capaces de mantener un flujo continuo y estable de materiales durante sus distintos procesos de producción y transformación. En este entorno, es fundamental contar con soluciones que favorezcan la continuidad operativa, la precisión y la integración con maquinaria industrial.",
    titulo: "Industria chocolatera", 
    ...
    subtituloCondicion: "En la industria textil, las condiciones de operación requieren sistemas de transporte capaces de adaptarse a procesos continuos, producción repetitiva e integración con distintos equipos de manufactura.",
    condiciones: [
      {
        id: 1,
        icono: "/images/Industria/textil/condicion/icono1.svg",
        titulo: "Automatización y repetitividad",
        descripcion: "Sistemas preparados para procesos repetitivos y líneas de operación automatizadas.",
      },
      {
        id: 2,
        icono: "/images/Industria/textil/condicion/icono2.svg",
        titulo: "Producción continua y flujo",
        descripcion: "Sistemas diseñados para mantener un movimiento constante de materiales durante el proceso productivo.",
      },

      {
        id: 3,
        icono: "/images/Industria/textil/condicion/icono3.svg",
        titulo: "Precisión y control",
        descripcion: "Equipos que permiten un manejo estable y controlado del material durante las distintas etapas del proceso.",
      },

      {
        id: 4,
        icono: "/images/Industria/textil/condicion/icono4.svg",
        titulo: "Integración con maquinaria existente",
        descripcion: "Soluciones compatibles con equipos de corte, confección, ensamblaje y automatización industrial.",
      },
    ],
    ...
    id: 17,
    tipo: "envasado",
    descripcion : "La industria de envases PET requiere sistemas de transporte capaces de mantener un flujo continuo y estable de envases durante procesos de fabricación, llenado, etiquetado y empaque.En este entorno, es fundamental contar con soluciones que favorezcan la continuidad operativa, la estabilidad del producto y la integración con líneas automatizadas.",
    titulo: "envase pet", 
    url: "/images/catalagos/industria/envasado/pet.pdf",
    ...
    condiciones: [
      {
        id: 1,
        icono: "/images/Industria/piedrera/condicion/icono1.svg",
        titulo: "Alta velocidad y volumen",
        descripcion: "Soluciones preparadas para líneas de operación con ritmos elevados y grandes volúmenes de producción.",
      },
      {
        id: 2,
        icono: "/images/Industria/piedrera/condicion/icono2.svg",
        titulo: "Producción continua y flujo",
        descripcion: "Sistemas diseñados para mantener un movimiento constante de envases durante el proceso productivo.",
      },

      {
        ...
        icono: "/images/Industria/piedrera/condicion/icono3.svg",
        titulo: "Automatización y repetitividad",
        descripcion: "Sistemas orientados a procesos automatizados y operaciones repetitivas de alta precisión.",
      },

      {
        ...
        icono: "/images/Industria/piedrera/condicion/icono4.svg",
        titulo: "Integración con maquinaria existente",
        descripcion: "Equipos compatibles con sistemas de llenado, etiquetado, inspección y empaque industrial.",
      },
    ],
