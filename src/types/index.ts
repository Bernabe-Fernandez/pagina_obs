...
import type { condicionItemBase, industriaBase, procesosBase, solucionBase, solucionesNewBase } from "../schemas/industrias-schema";
...
export type solucionesNewTipo = z.infer<typeof solucionesNewBase>;
